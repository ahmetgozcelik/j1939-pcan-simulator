"""Center panel showing the selected message's signal table.

The table supports inline raw/physical edits. Diagnostic DTC messages are shown
by ``DM1Panel`` instead; this module is used for regular single-frame messages.
"""
...
from j1939_pcan_simulator.protocol.frame_builder import physical_to_raw, raw_to_physical
from j1939_pcan_simulator.gui.table_delegates import HmiTableDelegate
from j1939_pcan_simulator.gui.theme import theme_color
from j1939_pcan_simulator.validation.workspace import signal_bit_positions
...
class SignalTableModel(QAbstractTableModel):
    ...
    # Emitted when a real user edit is committed.
    ...
    def setData(self, index: QModelIndex, value, role=Qt.EditRole) -> bool:
        ...
        try:
            ...
            return False
        # Repaint both raw and physical cells.
...
class SignalPanel(QWidget):
    ...
    def refresh(self) -> None:
        ...
        if msg is None:
            return
        # Refresh the affected row range instead of resetting the layout.
