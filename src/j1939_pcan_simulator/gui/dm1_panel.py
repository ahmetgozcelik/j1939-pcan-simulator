...
from j1939_pcan_simulator.protocol.frame_builder import build_dm1_frame, format_bytes
...
class DM1Panel(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.btn_open_definitions.setMinimumWidth(116)
        ...
        self.btn_reload_definitions.setMinimumWidth(96)
